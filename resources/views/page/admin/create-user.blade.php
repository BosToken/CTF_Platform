                ...
                <div class="w-full p-6 rounded-lg md:mt-0 sm:max-w-md bg-[#282d31] sm:p-8">
                    ...
                    <form class="mt-4 space-y-4 lg:mt-5 md:space-y-5" action="{{ route('admin-store-user') }}" method="post">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" placeholder="••••••••" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required="">
                        </div>
                        <div>
