    ...
    <section>
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
            <h1
                ...
                <a class="hover:underline" href="{{ route('admin-create-user') }}">Users</a>
            </h1>
                    ...
                    <tbody>
                        @foreach ($users as $key => $user)
                            <tr class="even:bg-blue-gray-50/50">
                                ...
                                <td class="p-4 block font-sans text-sm antialiased font-bold leading-normal text-blue-gray-900">
