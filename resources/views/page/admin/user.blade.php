        ...
        <tbody>
            @foreach ($users as $key => $user)
                <tr>
                    ...
                    <td><a href="/admin/user/detail/{{ $user->id }}" style="text-decoration: none;">{{ $user->username }}</a></td>
                    <td>{{ $user->name }}</td>
                </tr>
            @endforeach
        </tbody>
...
<x-layout.admin>
    <section>
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
            <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white"><a class="hover:underline" href="{{ route('admin-create-user') }}">Users</a></h1>
                ...
                <table class="w-full text-left table-auto min-w-max">
                  ...
                  <tbody>
                    ...
                    <tr class="even:bg-blue-gray-50/50">
                        ...
                        <td class="p-4">
                            <a href="/admin/user/detail/{{ $user->id }}" style="text-decoration: none;">{{ $user->username }}</a>
                        </td>
                        <td class="p-4">
