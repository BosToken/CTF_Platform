        ...
        <div class="max-w-screen-2xl flex flex-wrap justify-between mx-auto p-4">
          <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
            ...
            <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                @guest
                    <button type="button" onclick="window.location.href='/login'" class="text-white focus:ring-4 focus:outline-none font-medium rounded-lg text-sm py-2 text-center bg-[#D83639] hover:bg-red-700 focus:ring-red-700 px-10" style="margin-right: 10px;">Login</button>
                @else
                    <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar" class="text-white focus font-medium  flex items-center justify-between w-full py-2 px-3 rounded md:border-0 md:p-0 md:w-auto md:hover:text-red-700 focus:text-white border-gray-700 hover:bg-gray-700 md:hover:bg-transparent relative">
                        {{ Auth::user()->name }}
                        <svg class="w-2.5 h-2.5 ms-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                        </svg>
                    </button>
                    <div id="dropdownNavbar" class="z-10 hidden font-normal  divide-y divide-gray-100 rounded-lg shadow w-44 bg-[#282d31] dark:divide-gray-600 absolute right-0">
            ...
            <div class="items-center justify-start w-full md:flex md:w-auto md:order-1" id="navbar-cta">
                ...
                <li>
                    <a href="/" class="block py-2 px-3 md:p-0 text-white bg-red-600 rounded md:bg-transparent md:text-[#D83639]" aria-current="page">Dashboard</a>
                </li>
                <li>
                    <a href="{{ route("users") }}" class="block py-2 px-3 md:p-0 rounded md:hover:text-[#D83639] text-white hover:bg-[#D83639] hover:text-white md:hover:bg-transparent border-gray-700">Users</a>
                </li>
                <li>
                    <a href="{{ route("scoreboard") }}" class="block py-2 px-3 md:p-0 rounded md:hover:text-[#D83639] d:hover:text-[#D83639] text-white hover:bg-gray-700 hover:text-white md:hover:bg-transparent border-gray-700">Scoreboard</a>
                </li>
                <li>
                    <a href="{{ route("challenges") }}" class="block py-2 px-3 md:p-0 rounded md:hover:text-[#D83639] d:hover:text-[#D83639] text-white hover:bg-gray-700 hover:text-white md:hover:bg-transparent border-gray-700">Challenges</a>
                </li>
                </ul>
            </div>
        </div>
